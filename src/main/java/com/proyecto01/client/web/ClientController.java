package com.proyecto01.client.web;

import com.proyecto01.client.domain.Client;
import com.proyecto01.client.service.ClientService;
...
public class ClientController {
    ...
    @GetMapping("/document/{identityNumber}")
    public Mono<ResponseEntity<ClientModel>> getByIdentityNumber(@PathVariable String identityNumber){
        log.info("getByIdentityNumber executed {}", identityNumber);
